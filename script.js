// Banco de dados de veículos com links de imagens correspondentes aos modelos
const veiculos = [
    {
        id: 1,
...
function renderVeiculos(lista) {
    ...
    lista.forEach(veiculo => {
        // Link personalizado do WhatsApp para cada veículo
        ...
        const linkWhatsapp = `https://wa.me/5500999999999?text=${textoWhatsapp}`; 
...
// Filtro de Busca por Digitação e Categoria
...
// Inicializar a página carregando os veículos
